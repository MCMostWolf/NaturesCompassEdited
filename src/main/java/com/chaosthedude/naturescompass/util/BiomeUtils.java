...
public class BiomeUtils {
	public static Map<Boolean,List<Pair<Integer, Integer>>> foundbiomes = new ConcurrentHashMap<>();
	public static List<Pair<Integer,Integer>> coordinates = new ArrayList<>();
